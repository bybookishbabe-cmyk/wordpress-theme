...
if ($is_current && $promo_ends_at && $current_time >= $promo_ends_at) {
	return;
}
			...
			<?php if ($is_current) : ?>
				<div class="bbb-monthly-teaser__countdown" aria-label="Monthly theme is live">
					...
					<div class="bbb-monthly-teaser__timer" aria-live="polite">
						<span class="bbb-monthly-teaser__timerUnit bbb-monthly-teaser__timerUnit--wide"><strong>open</strong><span>through june 10</span></span>
					</div>
				</div>
			<?php else : ?>
